...
export function meta() {
  return [
    ...
    {
      name: "description",
      content: "Terms of service for React Router Boilerplate application.",
    },
  ];
}
      ...
      <div className="space-y-8">
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            <p>
              By accessing and using this React Router Boilerplate application
        ...
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            <p>
              This application is a boilerplate template designed to help
              developers build modern React applications with the following
              features:
            </p>
            <ul>
            ...
            <p>
              The Service is provided "as is" and is intended for development
        ...
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            <p>
              ...
              are and will remain the exclusive property of the service provider
              and its licensors.
            </p>
            <p>
