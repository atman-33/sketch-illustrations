...
export function meta() {
  return [
    ...
    {
      name: "description",
      content: "Privacy policy for React Router Boilerplate application.",
    },
  ];
}
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <ul>
              ...
              <li>
                ...
                how you use our application, including pages visited and
                features used.
              </li>
              <li>
        ...
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <ul>
              ...
              <li>
                <strong>Cloudflare:</strong> For hosting, database, and security
                services
              </li>
            </ul>
            <p>
