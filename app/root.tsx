...
export const links: Route.LinksFunction = () => [
  ...
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Schoolbell&display=swap",
  },
  {
...
export function Layout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body className="min-h-[100dvh] bg-page-light font-body text-page-foreground antialiased">
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
